...
Obsoletes: mysql55%{?1:-%1} = 5.5.29-1%%{?dist}
Obsoletes: mysql55%{?1:-%1} = 5.5.31-2%%{?dist}
Obsoletes: mysql55%{?1:-%1} = 5.5.33-1%%{?dist}
Obsoletes: mysql55%{?1:-%1} = 5.5.34-1%%{?dist}
Obsoletes: mysql55%{?1:-%1} = 5.5.36-1%%{?dist}
}
%mysql55_obsoletes
...
%triggerun server -- mysql55-server
[ $2 = 0 ] || exit 0
...
* Tue Oct 17 2017 Andy Thompson <andy@webtatic.com> 5.5.58-1
- Update to MySQL 5.5.58

* Sun Aug 06 2017 Andy Thompson <andy@webtatic.com> 5.5.57-1
- Update to MySQL 5.5.57

* Sat May 20 2017 Andy Thompson <andy@webtatic.com> 5.5.56-1
- Update to MySQL 5.5.56

* Sun Apr 23 2017 Andy Thompson <andy@webtatic.com> 5.5.55-1
- Update to MySQL 5.5.55

* Wed Dec 14 2016 Andy Thompson <andy@webtatic.com> 5.5.54-1
- Update to MySQL 5.5.54
...
* Tue Jun 21 2016 Andy Thompson <andy@webtatic.com> 5.5.50-1
- Update to MySQL 5.5.50

* Mon May 02 2016 Andy Thompson <andy@webtatic.com> 5.5.49-1
- Update to MySQL 5.5.49

* Sat Jan 16 2016 Andy Thompson <andy@webtatic.com> 5.5.47-1
- Update to MySQL 5.5.47

* Fri Oct 02 2015 Andy Thompson <andy@webtatic.com> 5.5.46-1
- Update to MySQL 5.5.46

* Sun Sep 13 2015 Andy Thompson <andy@webtatic.com> 5.5.45-1
- Update to MySQL 5.5.45
...
* Sat Oct 20 2012 Andy Thompson <andy@webtatic.com> 5.5.28-1
- Update to MySQL 5.5.28

* Wed Aug 15 2012 Andy Thompson <andy@webtatic.com> 5.5.27-1
...
* Sun Apr 29 2012 Andy Thompson <andy@webtatic.com> 5.5.23-1
- Update to MySQL 5.5.23

* Fri Mar 18 2011 Andy Thompson <andy@webtatic.com> 5.5.10-1
- Update to MySQL 5.5.10, for various fixes described at
  http://dev.mysql.com/doc/refman/5.5/en/news-5-5-10.html

* Sun Feb 20 2011 Andy Thompson <andy@webtatic.com> 5.5.9-2
- Fix mysql user creation

* Sat Feb 19 2011 Andy Thompson <andy@webtatic.com> 5.5.9-1
- Update to MySQL 5.5.9, for various fixes described at
  http://dev.mysql.com/doc/refman/5.5/en/news-5-5-9.html

* Mon Dec 27 2010 Andy Thompson <andy@webtatic.com> 5.5.8-1
- Update to MySQL 5.5.8
- Change spec to use new cmake build system and support 5.5
- Change package naming to mysql55
